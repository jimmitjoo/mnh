...
class WPO_Tweets_Widget extends WPO_Widget{
    ...
    public function form( $instance ) {
        ...
        <p>
            <label for="<?php echo $this->get_field_id( 'twitter_id' ); ?>"><?php _e('Twitter Widget ID (data-widget-id):', TEXTDOMAIN); ?></label><br>
			<span><?php _e('You need to go on https://twitter.com/settings/widgets create a new widget and get your Twitter widget id . You get this Twitter Widget Id from the code provided by Twitter when you create this widget data-widget-id="123456789"', TEXTDOMAIN); ?></span>
