...
class WPO_MetaBox
{
	...
	?>
		...
		?>
				<li class="tabs-<?php echo $element['id']; ?><?php echo ($count==1)? ' active': ''?>">
					<a href="#<?php echo $element['id']; ?>">
						<i class="fa <?php echo $element['icon']; ?>"></i>
	...
	?>
        ...
        <select name="<?php $this->the_name(); ?>" id="<?php echo $item['id']; ?>">
	        <?php foreach($item['data'] as $layout){ ?>
	            <option value="<?php echo $layout['id']; ?>" <?php $this->the_select_state($layout['id']); ?>><?php echo $layout['name']; ?></option>
	        <?php } ?>
        </select>
	...
	?>
        ...
        <label for="meta-checkbox">
            <input type="checkbox" name="<?php $this->the_name(); ?>" id="<?php echo $item['id']; ?>" value="1" <?php $this->the_checkbox_state($item['id'], 1); ?>>
	...
	?>
		<label><?php echo $item['title']; ?></label>
            <?php foreach($item['radios'] as $key=>$value) :?>
                <span for="meta-radio-<?php echo $key; ?>">
                    <input type="radio" name="<?php $this->the_name(); ?>" id="title_style-<?php echo $key; ?>" value="<?php echo $key; ?>" <?php $this->the_radio_state( $item['id'], $key ); ?>>
                    <?php echo  $value; ?>
                </span>
            <?php endforeach; ?>
		<?php
	...
	?>
		<label><?php echo $item['title']; ?></label>
        <input type="text" name="<?php $this->the_name(); ?>" style="width: 500px" id="<?php echo $item['id'];?>" value="<?php $this->the_value(); ?>"/>
	...
	?>
		<label><?php echo $item['title']; ?></label>
        <input type="number" name="<?php $this->the_name(); ?>" style="width: 100px" id="<?php echo $item['id'];?>" value="<?php $this->the_value(); ?>"/>
        <br/><?php echo $item['des']; ?>
        <p>
    <?php
	}
	...
	?>
		<label><?php echo $item['title']; ?></label>
        <textarea class="textarea " style="width: 500px; height: 100px" name="<?php $this->the_name(); ?>" id="<?php echo $item['id'] ?>"><?php $this->the_value(); ?></textarea>
	<?php
	}
	...
	function addColorElement() {
		...
		?>
		<label><?php _e( 'Background color ', TEXTDOMAIN)?></label>
...
?>
		<p class="wpo_section page-layout">
		    ...
		    <select  name="<?php $this->the_name(); ?>" style="display:none;">
		    	<option value="0-1-0" <?php $this->the_select_state('0-1-0'); ?>><?php echo __('Fullwidth',TEXTDOMAIN); ?></option>
		    	<option value="1-1-0" <?php $this->the_select_state('1-1-0'); ?>><?php echo __('Left Sidebar',TEXTDOMAIN); ?></option>
		    	<option value="0-1-1" <?php $this->the_select_state('0-1-1'); ?>><?php echo __('Right Sidebar',TEXTDOMAIN); ?></option>
		    	<option value="1-1-1" <?php $this->the_select_state('1-1-1'); ?>><?php echo __('Left & Right Sidebar',TEXTDOMAIN); ?></option>
		    </select>
		</p>
<?php
	}
